...
import DoctorReset from '../Doctorreset/DoctorReset';


export default function DoctorForgotOtp({email}) {
    ...
    async function handleSubmit(e) {
        ...
        const {data}= await axios.post("/doctor/auth/forgot/verify", {otp});
        if(data.err){
    ...
    {    
        showReset ?
        <DoctorReset otp={otp} email={email} />
        :
        <Row>
